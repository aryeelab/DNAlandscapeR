...
<a name="hic"></a>
### **HiC Visualization**
Due to the prohibitive size of HiC data, we've created our own compression format that is optimally designed to be used in **DNAlandscapeR**. For example, a 24 gigabyte normalize output from [HiC-Pro](https://genomebiology.biomedcentral.com/articles/10.1186/s13059-015-0831-x) was compressed to only 44 megabytes from the GM12878 cell line at 20kb resolution. While we are eager to get additional HiC data into the browser, we currently do not support users uploading their data locally due to the highly-specialized format. Thus, we ask that you please contact <A HREF="mailto:caleblareau@g.harvard.edu">Caleb</A> to facilitate the processing and addition of new HiC data into our browser. 
<hr>
<a name="faq"></a>
### **FAQ**
